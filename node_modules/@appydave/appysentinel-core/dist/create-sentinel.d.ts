...
import { type Signal, type SignalInput, type SignalPayload } from './signal.js';
 ...
 */
export declare function createSentinel(options: CreateSentinelOptions): Sentinel;
//# sourceMappingURL=create-sentinel.d.ts.map