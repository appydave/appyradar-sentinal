...
export declare const SIGNAL_SCHEMA_VERSION = "1.0.0";
/**
 ...
 */
export declare function mintSignal<P extends SignalPayload>(input: SignalInput<P>, context: SignalContext): Signal<P>;
